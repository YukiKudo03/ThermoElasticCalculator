...
{
    public ReglaFalsiOptimizer(Func<double, double> func, double initMin, double initMax, double thresh = 1e-8)
        : base(func, initMin, initMax, thresh) { }
...
{
    public SecantOptimizer(Func<double, double> func, double initMin, double initMax, double thresh = 1e-8)
        : base(func, initMin, initMax, thresh) { }
...
{
    public BisectionOptimizer(Func<double, double> func, double initMin, double initMax, double thresh = 1e-8)
        : base(func, initMin, initMax, thresh) { }
...
public static class OptimizerFactory
{
    public static Optimizer CreateOptimizer(Func<double, double> func, double initMin, double initMax, OptimizerType type)
    {
        return type switch
        {
            ...
            _ => new ReglaFalsiOptimizer(func, initMin, initMax),
        };
    }
}
